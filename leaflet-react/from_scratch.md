...
Each of these need to be accessible to terrier.js wherever they are served from.  So for now we just symlink them into this directory and also list them in the vite config.
